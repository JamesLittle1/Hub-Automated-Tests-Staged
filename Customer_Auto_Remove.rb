...
client = TinyTds::Client.new(:dataserver => ENV['DATASERVER_STAGED'], :database => ENV['DATABASE_STAGED'], :username => ENV['USERNAME_STAGED'], :password => ENV['PASSWORD_STAGED'], :timeout => 90000)
